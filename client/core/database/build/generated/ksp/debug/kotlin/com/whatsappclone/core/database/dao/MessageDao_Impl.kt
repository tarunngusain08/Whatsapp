  ...
  init {
    ...
    this.__insertionAdapterOfMessageEntity = object : EntityInsertionAdapter<MessageEntity>(__db) {
      protected override fun createQuery(): String =
          "INSERT OR IGNORE INTO `messages` (`messageId`,`clientMsgId`,`chatId`,`senderId`,`messageType`,`content`,`mediaId`,`mediaUrl`,`mediaThumbnailUrl`,`mediaMimeType`,`mediaSize`,`mediaDuration`,`replyToMessageId`,`status`,`isDeleted`,`deletedForEveryone`,`isStarred`,`timestamp`,`createdAt`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
