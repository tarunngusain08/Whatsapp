...
public final class WsEventRouter_Factory implements Factory<WsEventRouter> {
  ...
  public WsEventRouter get() {
    return newInstance(webSocketManagerProvider.get(), messageDaoProvider.get(), chatDaoProvider.get(), userDaoProvider.get(), chatParticipantDaoProvider.get(), typingStateHolderProvider.get(), jsonProvider.get());
  }
  ...
  public static WsEventRouter_Factory create(Provider<WebSocketManager> webSocketManagerProvider,
      ...
      Provider<UserDao> userDaoProvider, Provider<ChatParticipantDao> chatParticipantDaoProvider,
      Provider<TypingStateHolder> typingStateHolderProvider, Provider<Json> jsonProvider) {
    return new WsEventRouter_Factory(webSocketManagerProvider, messageDaoProvider, chatDaoProvider, userDaoProvider, chatParticipantDaoProvider, typingStateHolderProvider, jsonProvider);
  }
  ...
  public static WsEventRouter newInstance(WebSocketManager webSocketManager, MessageDao messageDao,
      ...
      TypingStateHolder typingStateHolder, Json json) {
    return new WsEventRouter(webSocketManager, messageDao, chatDao, userDao, chatParticipantDao, typingStateHolder, json);
  }
}
